/*멀티라인 주석: ctrl + shift + /(슬래시)
 멀티라인 주석 해제: ctrl + shift + \(역슬래시)
 싱글라인 주석 : ctrl + /(슬래시)
 싱글라인 주석 해제 : ctrl + \(역슬래시)
  AWT는 플랫폼에 따라 디자인이 다르게 표현되는 문제가 있기에, 
  AWT를 개선한 API인 Swing을 사용해 본다.
  Swinf은 새롭게 배울 필요 없으며, 기존 우리가 사용해오던 AWT 
  대부컴포넌트에 J 접두어가 붙는다. 
...
public class SwingTest extends JFrame{
	...
	public SwingTest() {
		...
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//윈도우 창 닫으면 프로세스도 함께 종료시킴
	}
